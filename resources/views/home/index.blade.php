...
<div class="container border p-4">
    <div class="row">
        <div class="col-sm-6">
            <div class="card">
                <div class="card-header">
                    <strong>Què és un filtre anti-xss?</strong>
                </div>
                <div class="card-body">
        ...
        <div class="col-sm-6">
            <div class="card">
                <div class="card-header">
                    <strong>De què em pot protegir?</strong>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <strong>Quina particularitat té el nostre filtre?</strong>
                </div>
                <div class="card-body">
    ...
    <div class="row mx-auto">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <strong>Hi ha més eines per afegir seguretat?</strong>
                </div>
                <div class="card-body">
